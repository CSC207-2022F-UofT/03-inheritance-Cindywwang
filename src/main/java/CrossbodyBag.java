...
public class CrossbodyBag extends Bag{
    ...
    @Override
    public void enhance(){super.increaseCapacity(2);}
    @Override
    public String toString(){return this.getColor() + " Crossbody Bag with "
            + this.getNumberOfStraps() + " straps"+ " ("+ this.numberOfContents + " / " +
            this.capacity + ")";}
}